          ...
          <div class="card-registration" v-if="!successful">
            ...
            <Form @submit="registrationRequest" :validation-schema="registrationFormSchema">
              <div class="form-group">
                <div>
                  <label for="fname" class="little-space">First Name</label>
                  <Field
                      id="fname"
                      name="fname"
                ...
                <div>
                  <label for="lname" class="little-space">Last Name</label>
                  <Field
                      id="lname"
                      name="lname"
                ...
                <div>
                  <label for="uname" class="little-space">User Name</label>
                  <Field
                      id="uname"
                      name="uname"
                ...
                <div>
                  <label for="confirmPassword" class="little-space">Confirm Password</label>
                  <Field
                      id="confirmPassword"
                      type="password"
            ...
            <ErrorModal title="Oops, registration error" :open="this.message !== '' && this.successful === false ? !isOpen : isOpen" @close="isOpen = !isOpen">
              {{ message }}
            </ErrorModal>
          </div>
        </div>
...
export default {
  ...
  data() {
    ...
    const registrationFormSchema = yup.object().shape({
      ...
      password: yup.string().min(8, "Min 8 Characters").max(20, "Max 20 characters").required("Password is required"),
...
.background-registration {
  background: url(../../assets/pexels-chris-f-1283219.png) no-repeat center center;
